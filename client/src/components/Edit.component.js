...
const EditComponent = props => {
    ...
    const handleSubmit = e => {
        ...
        axios.put(`http://localhost:8000/api/belt/${props.id}`,{...formState})
            .then(res=> {
                console.log(res)
                setValErrors("")
                navigate('/')
                        ...
                        <div className="d-flex">
                            <div className="d-flex" style={{flexDirection:"column",width:"200px"}}>
                                ...
                                <div>
                                    ...
                                    <input name="type" type="text" onChange={handleChange} value={formState.type}/>
                                    {valErrors.type ? <p style={{color:"red"}}>{valErrors.type.message}</p> : null}
                                </div>
                                <div>
                                    <label>Pet Description:</label>
                                    <input name="description" type="text" onChange={handleChange} value={formState.description}/>
                            ...
                            <div>
                                ...
                                <div>
                                    <label>Skill 1:</label>
                                    <input name="skill1" type="text" onChange={handleChange} value={formState.skill1}/>
                                </div>
                                <div>
                                    <label>Skill 2:</label>
                                    <input name="skill2" type="text" onChange={handleChange} value={formState.skill2}/>
                                </div>
                                <div>
                                    <label>Skill 3:</label>
                                    <input name="skill3" type="text" onChange={handleChange} value={formState.skill3}/>
                                </div>
                            </div>
                        </div>
